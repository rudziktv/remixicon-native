...
import * as Icon from './icons_animated';
import React from 'react';
import type { AnimatedProps } from 'react-native-reanimated';
import type { SvgProps } from 'react-native-svg';

const RemixIconAnimated = ({
  name = 'remixicon-line',
  size = 24,
  color = 'white',
  width: _,
...
export interface RemixIconAnimatedProps extends AnimatedProps<SvgProps> {
  name: RemixIconType;
  size?: number;
  color?: string;
}

export default RemixIconAnimated;
